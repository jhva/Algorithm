 ...
 * 각각 "지도 1"과 "지도 2"라고 하자. 지도 1 또는 지도 2 중 어느 하나라도
...
public class level1비밀지도 {
    ...
    static void solution(int n, int[] arr1, int[] arr2) {
        ...
        while (index < n) {
            ...
            for (int j = 0; j < n; j++) {
                if (value.charAt(j) == '1' || value2.charAt(j) == '1') {
                    temp += "#";
                } else {
                    temp += " ";
                }
...
//                    if (str.charAt(index) == '1' || str2.charAt(index) == '1') {
//                        temp += "#";
//                    }else{
//                        temp +=" ";
//                    }
...
////            if ("1".equals(value[index]) || "1".equals(value2[index])) {
////                temp += "#";
////            } else {
////                temp += " ";
////            }
