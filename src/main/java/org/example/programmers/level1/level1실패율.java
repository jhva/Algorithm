...
public class level1실패율 {
    public static void main(String[] args) {
        solve(5, new int[]{2, 1, 2, 6, 2, 4, 3, 3});
    }

    static void solve(int N, int[] stages) {
        ...
        for (int i = 1; i <= N; i++) {
            ...
            failureList.add(new double[]{i, cnt / user});
            user -= cnt;
            cnt = 0;
        }

        failureList.sort((a, b) -> Double.compare(b[1], a[1]));
...
//            }
//            if (cnt == 0) {
//                hashMap.put(i, (double) 0);
//            }
//            hashMap.put(i, (double) cnt / (double) total);
//            total = total - cnt;
//        }
...
//            list.add(i);
//        }
//        Collections.sort(list, (e1, e2) -> (hashMap.get(e2).compareTo(hashMap.get(e1))));
//
////        System.out.println(Arrays.toString(stages));
//
//        int temp = 0;
//        for (Integer listkey : list) {
//            temp++;
//            answer[temp - 1] = listkey;
//        }
